...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('spinel/assets/GF_assets');
				frames = tex;
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('spinel/assets/BoyFriend_Assets_SU', 'shared');
				frames = tex;
			...
			case 'bf-su':
			var tex = Paths.getSparrowAtlas('spinel/assets/BoyFriend_Assets_Change', 'shared');
			frames = tex;
